          ...
          <div className="flex-1 px-4 overflow-y-auto">
            ...
            <div className="space-y-2">
              <motion.button
                ...
                className="w-full flex items-center py-3.5 px-4 rounded-xl transition-all duration-300 hover:bg-gray-100/70 text-gray-600"
              >
                <Bell size={22} className="text-gray-500" />
                <span className="ml-4 font-medium text-gray-700">Notifications</span>
              </motion.button>
              ...
              <motion.button
                ...
                className="w-full flex items-center py-3.5 px-4 rounded-xl transition-all duration-300 hover:bg-gray-100/70 text-gray-600"
              >
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-gray-500">
                ...
                <span className="ml-4 font-medium text-gray-700">Paramètres</span>
              </motion.button>
            </div>
          </div>
